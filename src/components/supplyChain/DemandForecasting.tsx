...
const deleteForecastMutation = useMutation({
  ...
  onSuccess: () => {
    toast.success("Demand forecast deleted successfully");
    queryClient.invalidateQueries({ queryKey: ["demand_forecasting"] });
    queryClient.invalidateQueries({ queryKey: ["supply_chain_plans"] });
  },
  onError: (error: any) => {
  ...
  const handleDelete = (forecastId: string) => {
    if (window.confirm("Are you sure you want to delete this demand forecast?")) {
      deleteForecastMutation.mutate(forecastId);
    }
  };
